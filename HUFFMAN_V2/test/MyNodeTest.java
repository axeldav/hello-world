...
class MyNodeTest {
    ...
    public void testPutInEncodedMap(){
        ...
        huffman.addEncodedCharsToMap(i1);

        System.out.println(huffman.charMapping.get('a'));
        System.out.println(huffman.charMapping.get('b'));
        System.out.println(huffman.charMapping.get('d'));
        System.out.println(huffman.charMapping.get('e'));
    }
    ...
    public void testEncodeMessage(){
        ...
        /**
         * addEncodedCharsToMap()
         * lägger till i en lista som ser ut
         * a : 000
         * b : 001
         * och så vidaare
         */
    ...
    public void testEncodeHuffmanTree(){
        ...
        */
        ...
        assertEquals(
                huffman.encodeChar('d', root).toString(), "0x"  );
        assertEquals(
                huffman.encodeChar('b', root).toString(), "111x" );
    ...
    @Test
    public void testCreateFreqList(){
        HuffmanTree huffmanTree = new HuffmanTree();
        huffmanTree.createFreqList("abcdefghijklmmnopqrstuvwxyzzzz");
    }

    @Test
    public void testBuildNodeList(){
        HuffmanTree huffmanTree = new HuffmanTree();
        huffmanTree.buildNodeList("aaaaabbccddddeeffffffffffffggg ghj z");

        for (MyNode l:huffmanTree.nodeList) {
    ...
    public void testBuildHuffmanTree(){
        ...
        huffmanTree.setRoot(huffmanTree.buildHuffmanTree("aaaabbbccd"));
        System.out.println(huffmanTree.getRoot());
    }

    @Test
    public void testEncodeHuffmanTree_2(){

        //builds a huffman tree from text
        HuffmanTree huffmanTree = new HuffmanTree();
        huffmanTree.setRoot(huffmanTree.buildHuffmanTree("aaaabbbccd"));

        String s = huffmanTree.encodeMessage("abcd");
        System.out.println(s);
    }

    @Test
    public void testHuffmanCoder_encode(){
        HuffmanCoder huffmanCoder = new HuffmanCoder();
        EncodedMessage encodedMessage = huffmanCoder.encode("aaaabbbccd");
        String s = (String) encodedMessage.message;
        System.out.println(s);
    }
    @Test
    public void testHuffmanCoder_decode(){

        //ENCODING
        HuffmanCoder huffmanCoder = new HuffmanCoder();
        EncodedMessage encodedMessage = huffmanCoder.encode("aaaabbbccd");
        String encoded_s = (String) encodedMessage.message;


        //DECODING
        String decoded = huffmanCoder.decode(encodedMessage);
